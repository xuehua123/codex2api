...
//
// 示例：
//   codex_cli_rs/0.136.0 (Mac OS 15.5.0; arm64) Apple_Terminal/464
//   codex_cli_rs/0.136.0 (Mac OS 15.1.0; arm64) Ghostty/1.2.3
//   codex_cli_rs/0.136.0 (Windows 10.0.26120; x86_64) WindowsTerminal
