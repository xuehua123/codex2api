...
func (h *Handler) Responses(c *gin.Context) {
	...
	for attempt := 0; attempt <= maxRetries; attempt++ {
		...
		resp, reqErr := ExecuteRequest(c.Request.Context(), account, codexBody, sessionID, effectiveProxyURL, apiKey, deviceCfg, downstreamHeaders, useWebsocket)
		...
		h.store.BindSessionAffinity(sessionID, account, effectiveProxyURL)
